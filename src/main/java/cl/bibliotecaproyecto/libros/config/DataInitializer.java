...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        libroRepository.save(new Libro(null, "978-01", "El Quijote", 1605, 1L, 1L));
        libroRepository.save(new Libro(null, "978-02", "Cien Años de Soledad", 1967, 1L, 2L));
        libroRepository.save(new Libro(null, "978-03", "Harry Potter", 1997, 2L, 1L));
        libroRepository.save(new Libro(null, "978-04", "Clean Code", 2008, 3L, 3L));
